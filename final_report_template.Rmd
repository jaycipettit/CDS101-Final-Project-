...
The main goal of our project is to  investigate if time of day impacts the sale of hot chocolate/cocoa drinks.  
...
The logistic regression model achieved an accuracy of 0.835, meaning it correctly predicted whether a sale occurred in the evening about 83.5% of the time. From the confusion matrix:
